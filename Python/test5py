...
print( "장영주가" in set4) #set 내부에 지정데이터가 있는 확인
...
print( set4 )
a =set4.pop()  # 마지막 데이터를추출 삭제  , 마지막데이터를 추출하여 밖으로 빼고 set에서는 삭제
print(set4)
print( a )
set4.clear() # set을 비움
del set4  # set을 완전 삭제
...
member = [ ["김춘추","01012345678","남"], ["김지연","01033847263","남"] ,["이순신","01083942745","남"],
  ["하지원","01093846531","여"],["전계림","01032220205","남"],["전지현","01098376543","여"],
  ["윤재순","01011118875","여"],["이지현","01099884455","남"],["이요원","01023498746","여"]]
...
#  issuperset() -    a.isuperset(b)  b가 a에 모두 있냐?
# A가 B에 포함되어있냐?
...
#문제 2. 회원 가입을 하는데  이름이 중복되지않게 회원가입 될수 있도록 만들기 
